    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          {isOwner && (
            <>
              <h3 style={{ fontSize: 14, fontWeight: 700, color: "var(--muted)", marginBottom: 10, letterSpacing: 0.5 }}>💰 FINANSAI</h3>
          ...
          <Grid cols={2} gap={16} style={{ marginBottom: 20 }}>
            {/* Service type breakdown */}
            <Card>
              <h3 style={{ margin: "0 0 12px", fontSize: 14, fontWeight: 700, color: "var(--muted)" }}>🔧 Populiariausios paslaugos</h3>
            ...
            {/* Mechanic leaderboard */}
            <Card>
              <h3 style={{ margin: "0 0 12px", fontSize: 14, fontWeight: 700, color: "var(--muted)" }}>👨‍🔧 Meistrų aktyvumas</h3>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {mechLeaderboard.map((m, i) => (
                    <div key={m.name} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0", borderBottom: "1px solid var(--border)" }}>
                      ...
                      <span style={{ fontSize: 12, color: "var(--muted)" }}>{m.count} darbų</span>
          ...
          {/* ── Recent orders ── */}
          <Card>
            <h3 style={{ margin: "0 0 12px", fontSize: 14, fontWeight: 700, color: "var(--muted)" }}>📋 Paskutiniai užsakymai</h3>
